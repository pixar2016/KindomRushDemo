                ...
                switch (aJSON[i])
                {
                    ...
                    case ']':
                        ...
                        if (tokenBuilder.Length > 0)
                        {
                            TokenName = TokenName.Trim();
                            if (ctx is JSONArray)
                                ctx.Add(tokenBuilder.ToString());
                            else if (TokenName != "")
                                ctx.Add(TokenName, tokenBuilder.ToString());
                        }
                        TokenName = "";
                        tokenBuilder.Length = 0;
                        if (stack.Count>0)
                    ...
                    case ':':
                        ...
                        TokenName = tokenBuilder.ToString();
                        tokenBuilder.Length = 0;
                    break;
                        ...
                        if (QuoteMode)
                        {
                            ...
                            switch (C)
                            {
                                ...
                                case 'u':
                                {
                                    ...
                                    tokenBuilder.Append(int.Parse(s, System.Globalization.NumberStyles.AllowHexSpecifier));
                                    i += 4;
                                    break;
                                }
                                default  : 
